<template>
  <div class="grid md:grid-cols-2 gap-4">
    <div class="shadow-md bg-b-blue p-10 text-center rounded">
    ...
    <div class="shadow-md bg-b2-blue p-10 text-center rounded">
      <h3 class="text-3xl text-t-red font-bold mb-4">Deaths</h3>
      <div class="text-2xl mb-4">
        <span class="font-bold">New:</span>
